  ...
  return (
    <div className="flex justify-start gap-[34px] mt-[75px] px-[7px] w-full max-w-[1259px]">
      {companyStatsData.map((companyStat) => {
        const isVisibleOnLg = companyStat.id === 1 || companyStat.id === 2;
        return (
          <div
            key={companyStat.id}
            className={`  ${
              isVisibleOnLg ? '' : 'hidden xl:flex'
            } flex gap-[20px] bg-[#FFFFFF99] shadow-[0px_0px_9.9px_0px_#00000040] px-[15px] py-[20px] border-[#583CCF] border-[2px] rounded-[8px] w-full max-w-[396px] min-h-[103px]`}
          >
